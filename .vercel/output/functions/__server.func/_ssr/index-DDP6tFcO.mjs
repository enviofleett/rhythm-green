...
function Hero() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { id: "top", className: "relative min-h-screen flex items-center justify-center overflow-hidden", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative max-w-6xl mx-auto px-6 text-center pt-24 pb-16 animate-fade-in", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-8 mx-auto max-w-2xl text-white/60 text-base sm:text-lg leading-relaxed", children: "World-class drumsticks manufactured with premium Igala hardwood. Wholesale & distribution partnerships available worldwide." }),
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "relative py-32 px-6 lg:px-10 bg-forest-deep", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto grid lg:grid-cols-2 gap-16 items-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative order-2 lg:order-1", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rounded-xl overflow-hidden border border-white/10", children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: woodImage, alt: "Premium Igala hardwood", width: 1200, height: 1500, loading: "lazy", className: "w-full h-[600px] object-cover" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute top-6 left-6 bg-forest-deep/80 backdrop-blur-md border border-white/10 rounded-lg p-5 max-w-[240px]", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white font-bold mt-2", children: "Igala Hardwood" }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "order-1 lg:order-2", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "text-white text-4xl md:text-6xl font-black tracking-tight leading-[1.05]", children: [
          "The Power of ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gold", children: "Igala Wood" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-8 text-white/65 text-lg leading-relaxed font-light", children: "At the heart of every Zenbeatz drumstick lies rare, premium Igala hardwood — carefully selected for exceptional performance. Igala wood gives our sticks strength without sacrificing feel. The result? A drumstick that sits perfectly in your hand and responds with precision every time you strike." }),
